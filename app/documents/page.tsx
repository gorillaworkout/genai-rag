...
import { FileText, Calendar, Hash, Eye, Filter, ChevronLeft, ChevronRight, RefreshCw, Loader2, Search, CheckCircle, Maximize2, Minimize2, ArrowLeft } from 'lucide-react';
...
export default function DocumentsPage() {
  ...
  const limit = 20; // Increased limit for page view
    ...
    try {
      ...
      if (data.ok) {
        ...
        setVerificationResult({
          isCorrect: data.confidence?.overallConfidence >= 7,
        ...
        <div className="bg-white rounded-xl shadow-xl w-full max-w-6xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            ...
            <button
              ...
              className="p-3 text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-lg transition-all duration-200"
            >
          ...
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Documents Viewer</h1>
                  <p className="text-gray-600">Browse and search through all available documents</p>
                </div>
              </div>
            </div>
          ...
          <div className="xl:col-span-1 space-y-6">
                ...
                <div className="mt-4">
                  ...
                  <div className="max-h-64 overflow-y-auto space-y-2">
                    {searchResults.map((doc) => (
                      <div key={doc.id} className="p-3 bg-gray-50 border border-gray-200 rounded text-sm">
                        <span className="font-medium text-gray-900 block mb-1">{doc.metadata?.source || 'Unknown'}</span>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Documents per Page:</span>
